...
description: Use when the user explicitly asks to create, edit, fix, render, or validate a Mermaid/software diagram; requests a flowchart, sequence diagram, class diagram, ERD, C4 diagram, state diagram, git graph, Gantt chart, or asks to "diagram", "map", "visualize", or "show the flow".
---
