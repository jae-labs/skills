...
description: Use when a Terraform module refactor is requested, especially to split monolithic Terraform configurations into reusable modules, extract shared infrastructure modules, or redesign Terraform module interfaces.
metadata:
