...
name: fuck-slop
description: >
  Use when the user explicitly asks to "fuck slop", "f*ck slop", "deslop",
  "de-slop this", "remove the AI tells", "humanize this", "make this not
  sound like AI", or invokes /fuck-slop.
---
